...
class SellerMainNavigationScreen extends StatefulWidget {
  ...
  const SellerMainNavigationScreen({super.key, this.initialIndex = 0});
...
class _SellerPlaceholderScreen extends StatelessWidget {
  final String title;
  final IconData icon;

  const _SellerPlaceholderScreen({required this.title, required this.icon});
