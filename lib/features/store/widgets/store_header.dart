...
class StoreHeader extends StatefulWidget {
  ...
  @override
  State<StoreHeader> createState() =>
      _StoreHeaderState();
}

class _StoreHeaderState
    extends State<StoreHeader> {
  ...
  Future<void> _loadUnreadCount() async {
    try {
      ...
      debugPrint(
        'Customer notification count error: $error',
      );
    }
  }
  ...
  void _listenForNotifications() {
    _notificationSubscription =
      ...
      onError: (Object error) {
        debugPrint(
          'Customer notification stream error: $error',
        );
      },
    );
  }
...
class _CustomerNotificationButton
    extends StatelessWidget {
  final int count;
  final VoidCallback onTap;

  const _CustomerNotificationButton({
    required this.count,
    required this.onTap,
  });
...
class _StoreStatusDialog
    extends StatelessWidget {
  final bool isOpen;

  const _StoreStatusDialog({
    required this.isOpen,
  });
